        ...
        >
          ...
          >
            ...
            >
              ...
              <td class="text-xs-right">{{ item.sendingOrg }}</td>
              <td class="text-xs-right">{{ item.flow }}</td>
              <td class="text-xs-right" v-if="item.acceptedFlow">YES</td>
              <td class="text-xs-right" olor="danger" v-if="!item.acceptedFlow">NO</td>
            </template>
          </v-data-table>
        </material-card>
      </v-flex>
  ...
  computed: {
    ...
    acceptedStats() {
      ...
      if(total) {
          ...
          return accStd.length + '/' + total.length
        } else {
          return 'loading'
        }
      // return accStd.length + '/' + total.length
