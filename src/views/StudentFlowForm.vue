          ...
          <v-form>
            <v-container py-0>
              <v-layout wrap>
                ...
                >
                  <v-combobox
                    v-model="newStudent.personalCompetencies"
                    :items="personalC"
                    :search-input.sync="search1"
                    hide-selected
                    hint="Maximum of 4 competencies"
                  ...
                  >
                    <template v-slot:no-data>
                      <v-list-item>
                        <v-list-item-content>
                          <v-list-item-title>
                            Press <kbd>enter</kbd> to create a new personal competency.
                          </v-list-item-title>
                        </v-list-item-content>
                      </v-list-item>
                    </template>
                ...
                >
                  <v-combobox
                    v-model="newStudent.vocationalCompetencies"
                    :items="vocationalC"
                    :search-input.sync="search2"
                    hide-selected
                    hint="Maximum of 4 competencies"
                    label="Vocational competencies"
                    multiple
                    persistent-hint
                    small-chips
                    color="purple"
                  >
                    <template v-slot:no-data>
                      <v-list-item>
                        <v-list-item-content>
                          <v-list-item-title>
                            Press <kbd>enter</kbd> to create a new vocational competency.
                          </v-list-item-title>
                        </v-list-item-content>
                      </v-list-item>
                    </template>
...
export default {
  ...
  methods: {
    ...
    // }
    createStudent() {
        let personal = this.newStudent.personalCompetencies;
        let vocational = this.newStudent.vocationalCompetencies;
        let compsArray = [];
        personal.forEach(c => {
          compsArray.push({
            color: "yellow",
